        ...
        <section ref={containerRef} className="relative w-full py-32 px-4 md:px-8 flex flex-col items-center justify-center text-center">
            ...
            <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
                ...
                <p className="join-animate font-sans text-[#FFFFFF52] text-lg md:text-xl leading-relaxed mb-12">
                    We'll help you bring it to life. Whether you have a full brief or just an idea — let's start a conversation.
                </p>
                <a
                    href="#contact"
                    onClick={(e) => {
                    ...
                    className="join-animate group bg-[#006AFF] text-white font-sans font-bold py-4 px-8 flex items-center gap-3 cursor-pointer hover:bg-[#0058D6] transition-colors duration-300"
                >
                    Send Proposal
